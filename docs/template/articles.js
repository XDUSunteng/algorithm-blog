module.exports = {
    getTemplateSidebar: () => [{
        ...
        children: [
            ...
            '/template/01.primary-algorithm/模板-序列的第K大元素值.md',
            '/template/01.primary-algorithm/模板-离散化.md',
            '/template/01.primary-algorithm/模板-货仓选址-中位数.md',
            '/template/01.primary-algorithm/模板-ST表.md',
            '/template/01.primary-algorithm/模板-K叉哈夫曼树.md',
            '/template/01.primary-algorithm/模板-区间分组-贪心.md',
            '/template/01.primary-algorithm/模板-区间选点-贪心.md',
            '/template/01.primary-algorithm/模板-悬线法.md',
            '/template/01.primary-algorithm/模板-高精度.md',
            '/template/01.primary-algorithm/模板-区间合并.md',
        ],
    }, {
        title: '初级数据结构',
        children: [
            ...
            '/template/02.primary-data-structure/模板-树的最小表示法.md',
            '/template/02.primary-data-structure/模板-序列的前K大元素值.md',
        ...
        children: [
            ...
            '/template/04.mathematics/模板-求欧拉函数的前n项-线性筛.md',
            '/template/04.mathematics/模板-求欧拉函数的第n项-试除法.md',
            '/template/04.mathematics/模板-求约数-试除法.md',
            ...
            '/template/04.mathematics/模板-高斯消元解异或线性方程组.md',
            '/template/04.mathematics/模板-卡特兰数.md',
        ...
        children: [
            ...
            '/template/05.advanced-data-structure/模板-线段树.md',
            '/template/05.advanced-data-structure/模板-可持久化权值线段树_主席树_.md',
            '/template/05.advanced-data-structure/模板-权值线段树.md',
        ...
        title: '图论',
        children: [
            '/template/07.graph-theory/模板-拓扑排序.md',
            ...
            '/template/07.graph-theory/模板-染色法.md',
        ],
    }, {
        title: '字符串',
        children: [
            
            '/template/08.string/模板-字符串哈希.md',
            '/template/08.string/模板-KMP.md',
            '/template/08.string/模板-Trie.md',
            '/template/08.string/模板-可持久化Trie.md',
            '/template/08.string/模板-AC自动机.md',
            '/template/08.string/模板-后缀数组.md',
            '/template/08.string/模板-最长回文子串.md',
        ],
    }, {
        title: '综合技巧与实践',
        children: [
